...
#define PCI_SET_PORTS 16
#define PCI_CHECK_BUSES 17
#define PCI_DEVICE_GET_VALUE 18
#define PCI_DEVICE_SET_VALUE 19
#define PCI_DEVICE_SET_MASTER 20
#define PCI_DEVICE_CLEAR_MASTER 21
